...
export const VLCUrls = [
    { url: 'https://raw.githubusercontent.com/videolan/vlc/master/po/ar.po', type: 'po', projectAr: 'في إل سي', projectEn: 'VLC', publisherAr: 'في إل سي', publisherEn: 'VLC' }
]