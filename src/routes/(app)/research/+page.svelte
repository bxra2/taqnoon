...
>
  ...
  {#if finalStats && finalStats.translations.length > 0}
    <div class="space-y-6 animate-in fade-in slide-in-from-bottom-2 relative left-1/2 right-1/2 -ml-[-10vw] -mr-[40vw]">
      <h2 class="text-2xl font-bold">الاحصائيات المجمعة</h2>
      <div class="flex flex-col lg:flex-row gap-6">
        <!-- Charts -->
        <div class="flex-1 p-6 rounded-xl shadow-sm border">
            ...
            {#each finalStats.translations as tr}
              <div>
                <div class="flex justify-between items-end mb-1 gap-4">
                  ...
                  <span class="font-mono text-sm opacity-60 text-left whitespace-nowrap" dir="ltr"
          ...
          <div class="p-6 rounded-xl shadow-sm border">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-3">
              {#each finalStats.publishers as pub}
                ...
                >
                  <span class="font-medium truncate">{pub.publisher}</span>
                  <span
